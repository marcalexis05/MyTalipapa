        ...
        {NAV_ITEMS.map(({ id, label, path, Icon }) => {
          ...
          return (
            ...
            >
              ...
              {id === 'nav-requests' && pendingRequestsCount > 0 && (
                <span className="absolute top-1 right-1/4 w-3.5 h-3.5 flex items-center justify-center rounded-full bg-[#f59e0b] text-[8px] font-bold text-white border border-white">
